  ...
  return (
    <MitraAuthGuard>
      <MitraDashboardLayout 
        title="Layanan" 
        subtitle="Kelola layanan yang Anda tawarkan"
      >
        <div className="bg-white rounded-lg border border-base-200 p-8">
          <div className="text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-base-900">Halaman Layanan</h3>
            <p className="mt-1 text-sm text-base-500">
              Fitur manajemen layanan akan segera tersedia
            </p>
          </div>
        </div>
      </MitraDashboardLayout>
